...
function [neural_net,y_predicted, learning_rate, derivated_cost]= train(neural_net,X,Y,...
...
[neural_net, derivated_cost] = backpropagation(neural_net,cost_function, out, learning_rate, Y);  
