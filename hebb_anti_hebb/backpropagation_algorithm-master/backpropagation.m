function [neural_net, derivated_cost] = backpropagation(neural_net, cost_function, out, learning_rate, Y)
%BACKPROPAGATION  update the weights using the backpropagation algorithm
%  
